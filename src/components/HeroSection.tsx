      ...
      <div className="flex flex-col lg:flex-row items-center min-h-screen">
        ...
        <div className="flex-1 order-1 lg:order-2 mb-24 py-6 sm:py-8 lg:py-20 flex flex-col justify-center items-center px-4 lg:pr-8 min-h-[50vh] lg:min-h-[80vh] relative">
          <div className="text-center lg:text-left w-full max-w-lg lg:max-w-none relative">
            {/* Texto "Soy" flotante */}
            <p className="absolute -top-12 left-1 lg:left-0 text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-meow-script text-white translate-y-[-20%] ">
              Soy
            </p>

            {/* Nombre en fucsia */}
            <div className="pt-12 text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-brand-fucsia uppercase tracking-tight font-poppins font-bold leading-none relative z-10">
              <div>ROSANA</div>
